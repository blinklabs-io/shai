...
func (a *LiqwidLendingAdapter) ParseDatum(
	...
	marketState, marketErr := a.parser.ParseMarketDatum(
		datum,
		txHash,
		txIndex,
		slot,
	...
	// Try oracle feed datum
	oracleState, err := a.parser.ParseOracleDatum(
		datum,
		txHash,
		slot,
		timestamp,
	...
	if err == nil {
		return a.oracleToLendingState(oracleState, txIndex), nil
	}
...
// oracleToLendingState converts a Liqwid OracleState to LendingState
func (a *LiqwidLendingAdapter) oracleToLendingState(
	o *liqwid.OracleState,
	txIndex uint32,
) *LendingState {
	return &LendingState{
		StateId:           o.Key(),
		StateType:         LendingStateTypeOracle,
		Protocol:          liqwid.ProtocolName,
		UnderlyingAsset:   o.Asset,
		OraclePrice:       o.Price,
		OracleDenominator: o.Denominator,
		OraclePriceValue:  o.PriceFloat(),
