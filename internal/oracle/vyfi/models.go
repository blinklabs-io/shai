...
const (
	...
	// Pool script hash (mainnet)
	// Extracted from VyFi pool address on Cardanoscan
	// Address: addr1z9vgl40qezca5s8ajz6wnpuwevt98l3jqx2ce5nlu8h8nnw60wckas4haxwwclas0g39cc8cvt2r8yalrfa9e8vxx92qsss9sx
	// Contract version: v1, Language: PLUTUS v1
	// VyFi pools are identified by unique pool NFTs
	PoolScriptHash = "588fd5e0c8b1da40fd90b4e9878ecb1653fe3201958cd27fe1ee79cd"

	// LP token policy (mainnet) - to be confirmed from VyFi documentation
	// LP tokens represent ownership share of liquidity pools
	LPTokenPolicy = ""
)
...
type PoolDatum struct {
	...
	TreasuryA    int64 // Reserve/treasury for asset A
	TreasuryB    int64 // Reserve/treasury for asset B
	IssuedShares int64 // Total LP shares issued
}
...
type OrderDetails struct {
	...
	MinWantedShares int64

	// For TradeAToB, TradeBToA
	MinWantedTokens int64

	// For RemoveLiquidity
	MinWantedTokensA int64
	MinWantedTokensB int64
}
