		...
		poolConfigObj: spectrum.PoolConfig{
			Nft: spectrum.AssetClass{
				PolicyId: testModelsDecodeHex(
					"a22ebe57c45d0be3ba4bebca5a9d4877b42d7fd872f3d740414fa124",
				),
			...
			Lq: spectrum.AssetClass{
				PolicyId: testModelsDecodeHex(
					"ad951d57c5b1e4e0bfc503dc7e4080bdb89db179e6853a271ca1b129",
				),
			...
			AdminPolicy: [][]byte{
				testModelsDecodeHex(
					"13d68210e8e25f69ea14c5f381d010eb3fac36afa9faa240509b81b9",
				),
			},
			LqBound: 0x4a817c800,
		},
	},
	{
		...
		poolConfigObj: spectrum.PoolConfig{
			Nft: spectrum.AssetClass{
				...
				PolicyId: testModelsDecodeHex(
					"0891dc34b96a4d705e11f0a1d14a3eb582623bffa38a9052a9dc1f20",
				),
			...
			Y: spectrum.AssetClass{
				...
				PolicyId: testModelsDecodeHex(
					"d542ad1dc269ae601125e8259cb8427c6b37c1d3569d10441df0291f",
				),
				Name: []byte("AI"),
			},
			Lq: spectrum.AssetClass{
				...
				PolicyId: testModelsDecodeHex(
					"895af34f5ef7d077d35d2b48a35df9b2c893e4621332a014ad62cb93",
				),
				Name: []byte("AI_ADA_LQ"),
			},
			FeeNum:      997,
