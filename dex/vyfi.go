...
const (
	...
	VyFiPoolScriptHash = "588fd5e0c8b1da40fd90b4e9878ecb1653fe3201958cd27fe1ee79cd"
	VyFiLPTokenPolicy  = ""
)
...
// pool UTxOs.
func (p *VyFiParser) PoolAddresses() []string {
...
func (p *VyFiParser) ParsePoolDatum(
	...
	state, err := p.parser.ParsePoolDatum(datum, utxoValue, txHash, txIndex, slot, timestamp)
	if err != nil {
		return nil, err
	}
